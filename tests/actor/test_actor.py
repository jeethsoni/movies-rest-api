...
from blueprints.actor import service
...
def fake_data():
    ...
    faker_data["gender"] = fake.pystr(min_chars=0, max_chars=25)
    faker_data["age"] = fake.pyint()
...
def test_svc_get(mocker, fake_data):
    ...
    assert data[0]["gender"] == fake_data["gender"]
    assert data[0]["age"] == fake_data["age"]
