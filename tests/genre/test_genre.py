...
def fake_data():
    ...
    faker_data["name"] = fake.pystr(min_chars=0, max_chars=75)
...
def test_svc_get(mocker, fake_data):
    ...
    assert data[0]["name"] == fake_data["name"]
...
def test_svc_like_search(mocker, fields_payload, fake_data):
    """
    LIKE search test function
    """
